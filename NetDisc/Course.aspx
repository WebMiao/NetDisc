...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin:0 auto; width:900px; padding:5px">
        ...
        <div style="margin: 0 auto; width:900px;height:150px">
            <asp:Label ID="lbDescription" runat="server" Text="" Font-Names="Century Gothic" Font-Size="Large" ForeColor="Black"></asp:Label>
        </div>
