...
function TreeNode()
{
    ...
    this.Show = function()
    {
        ...
        this.imgPlus = createImage(image.Plus); //small icon before file name
        this.imgPlus.onclick = self.clickNode; //onclick task
    ...
    this.CreateChildren = function()
    {
        if (this.childrenNodes == null)
        {
            ...
            //when create the tree, you need to send a request to the server
            //the defaultURL is defined in Ajax
