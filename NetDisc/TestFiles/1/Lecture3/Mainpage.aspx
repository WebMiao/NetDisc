...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="margin:0 auto; width:950px; padding:30px">
        ...
        <div  style="margin:0 auto; width:900px; height:500px">
            ...
            <asp:bulletedlist id="bulletedlist1" runat="server" DataTextField="coursename" DataValueField="coursename" DisplayMode="LinkButton" Font-Names="Century Gothic" Font-Size="X-Large" ForeColor="Black" BulletStyle="Numbered" OnClick="bulletedlistitem_Click">
