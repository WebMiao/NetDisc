...
<div style="margin:0 auto; width:600px; height:200px; padding-left:100px; padding-right:100px; padding-top:50px">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:RadioButton ID="rbUser" Checked="true" runat="server" GroupName="Type" Text="Teacher" Font-Names="Century Gothic" Font-Size="Small"/>
                    <asp:RadioButton ID="rbAuthor" Checked="false" runat="server" GroupName="Type" Text="Student" Font-Names="Century Gothic" Font-Size="Small"/>
                </td>
            </tr>
        </table>
        </div>
